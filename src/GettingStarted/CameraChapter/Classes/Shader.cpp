...
void Shader::setVariableMatrix4(const std::string& variableName, glm::mat4 value) const
{
    glUseProgram(m_shaderProgram);
    glUniformMatrix4fv(glGetUniformLocation(m_shaderProgram, variableName.c_str()), 1, GL_FALSE, glm::value_ptr(value));
}
