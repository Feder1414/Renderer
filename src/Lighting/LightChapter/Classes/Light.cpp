...
namespace
{
    std::unordered_map<LightProperty, std::string> lightPropertyEnumToStr = {
        ...
        {LightProperty::AttenuationConstant, "attenuationConstant"},
        {LightProperty::AttenuationLinear, "attenuationLinear"},
        {LightProperty::AttenuationQuadratic, "attenuationQuadratic"},
        {LightProperty::LightType, "lightType"}
    };
}
